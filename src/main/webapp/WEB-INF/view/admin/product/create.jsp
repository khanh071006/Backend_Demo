                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="mb-3 col-12 col-md-6">
                                        ...
                                        <form:select class="form-select" aria-label="Role" path="factory">
                                            ...
                                            <form:option value="2">Asus</form:option>
                                            <form:option value="3">Lenovo</form:option>
                                            <form:option value="4">Dell</form:option>
                                            <form:option value="5">LG</form:option>
                                            <form:option value="6">Acer</form:option>
                                        </form:select>
                                    </div>
                                    ...
                                    <div class="mb-3 col-12 col-md-6">
                                        ...
                                        <form:select class="form-select" aria-label="Role" path="target">
                                            ...
                                            <form:option value="2">Sinh viên - Văn phòng</form:option>
                                            <form:option value="3">Thiết kế đồ họa</form:option>
                                            <form:option value="4">Mỏng nhẹ</form:option>
                                            <form:option value="5">Doanh nhân</form:option>
                                        </form:select>
                                    </div>
